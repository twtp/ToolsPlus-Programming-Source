...
namespace Connectivity
{
    public static class HTTPCalls
    {
        ...
        {
            return HTTP_GET(Url, new List<string>());
        }

        public static string HTTP_GET(string Url, List<string> httpHeader)
        {

            System.Net.HttpWebRequest req = (System.Net.HttpWebRequest)System.Net.WebRequest.Create(Url);
            req.Credentials = System.Net.CredentialCache.DefaultCredentials;
            req.UserAgent = "Mozilla/5.0 (Windows NT 6.1; Trident/7.0; rv:11.0) like Gecko";
            foreach (string header in httpHeader)
            {
                if (header.Contains("Content-type:") == true)
                {
                    req.ContentType = header.Split(':')[1];
                }
                else
                {
           ...
           /* string resultsString = "";
            ...
            foreach(string str2 in httpHeader)
            {
        ...
        {
            return HTTP_PUT(Url, Data, new List<string>());
        }

        public static string HTTP_PUT(string Url, string Data, List<string> httpHeader)
        {
        ...
        public static string HTTP_POST(string Url, string Data, List<string> httpHeader)
        {
            string Out = String.Empty;
            System.Net.WebRequest req = System.Net.WebRequest.Create(Url);
