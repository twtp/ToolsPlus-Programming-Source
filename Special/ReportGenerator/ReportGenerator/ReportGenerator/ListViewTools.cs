...
namespace ReportGenerator
{
    public static class ListViewTools
    {
        ...
        public static ListView ColumnRowLists_to_LVI(List<string> Columns, List<string> Rows, ref ListView reportLVI)
        {
            ...
            {
                ColumnHeader theCol = new ColumnHeader();
                theCol.Text = col;
                reportLVI.Columns.Add(theCol);
            }
