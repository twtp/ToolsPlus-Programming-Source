...
namespace ExpressCubeController
{
    ...
    {
        ScaleJacker.ApplicationInterfacing.StarShipHandles ssh = new ScaleJacker.ApplicationInterfacing.StarShipHandles();
        ScaleJacker.ApplicationInterfacing.WeightDimensions wd = new ScaleJacker.ApplicationInterfacing.WeightDimensions();
        ...
        {
            if (ScaleJacker.ApplicationInterfacing.dimensionOn_fromStarShip != checkBox1.Checked)
            {
                checkBox1.Checked = ScaleJacker.ApplicationInterfacing.dimensionOn_fromStarShip;
            }
            if (ScaleJacker.ApplicationInterfacing.scaleOn_fromStarShip != checkBox2.Checked)
            {
                checkBox2.Checked = ScaleJacker.ApplicationInterfacing.scaleOn_fromStarShip;
            }
            ResponseData += text;
            ...
            if (ResponseData.EndsWith("\r\n") == true)
            {
                ...
                if (test == true)
                {
                    ...
                    wd.Length = ExpressCubeLiveData.Length;
                    wd.Width = ExpressCubeLiveData.Width;
                    wd.Height = ExpressCubeLiveData.Height;
                    wd.Weight = ExpressCubeLiveData.Weight;
                    ssh.Update_Starship(wd,checkBox1.Checked,checkBox2.Checked);
                    ScaleJacker.ApplicationInterfacing.UpdateCheckBox(true, true, ssh.StarShip_ParentHandle);
                }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            ssh.EnumerateHandles();
            this.ScaleCheckBox = ScaleJacker.ApplicationInterfacing.CreateCheckBox(ssh.StarShip_ParentHandle, 10, 95, 20, 82, "Scale");
            this.DimensionCheckBox = ScaleJacker.ApplicationInterfacing.CreateCheckBox(ssh.StarShip_ParentHandle, 10, 43, 20, 82, "Dimensions");
            this.ScaleButton = ScaleJacker.ApplicationInterfacing.CreateButton(ssh.StarShip_ParentHandle, 97, 94, 28, 80, "Set Weight");
        }
        ...
        private void checkBox1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                ScaleJacker.ApplicationInterfacing.dimensionOn_fromStarShip = true;
            }
            else
            {
                ScaleJacker.ApplicationInterfacing.dimensionOn_fromStarShip = false;
            }
            ScaleJacker.ApplicationInterfacing.NativeMethods.SendMessage(ssh.StarShip_LengthHandle, ScaleJacker.ApplicationInterfacing.NativeMethods.WM_SETTEXT, null, "");
            ScaleJacker.ApplicationInterfacing.NativeMethods.SendMessage(ssh.StarShip_WidthHandle, ScaleJacker.ApplicationInterfacing.NativeMethods.WM_SETTEXT, null, "");
            ScaleJacker.ApplicationInterfacing.NativeMethods.SendMessage(ssh.StarShip_HeightHandle, ScaleJacker.ApplicationInterfacing.NativeMethods.WM_SETTEXT, null, "");
        ...
        private void checkBox2_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                ScaleJacker.ApplicationInterfacing.scaleOn_fromStarShip = true;
            }
            else
            {
                ScaleJacker.ApplicationInterfacing.scaleOn_fromStarShip = false;
                ScaleJacker.ApplicationInterfacing.NativeMethods.SendMessage(ssh.StarShip_WeightHandle, ScaleJacker.ApplicationInterfacing.NativeMethods.WM_SETTEXT, null, "");
            }
        }
    }
}
