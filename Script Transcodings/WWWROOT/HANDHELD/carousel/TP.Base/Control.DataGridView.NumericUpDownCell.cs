...
namespace TP.Base.Control.DataGridView {
  ...
  public class NumericUpDownCell : DataGridViewTextBoxCell {
    ...
    /// </summary>
    [
        System.ComponentModel.DefaultValue(DATAGRIDVIEWNUMERICUPDOWNCELL_defaultDecimalPlaces)
    ]
    ...
    /// </summary>
    [
        System.ComponentModel.DefaultValue(DATAGRIDVIEWNUMERICUPDOWNCELL_defaultThousandsSeparator)
    ]
    ...
    private Decimal Constrain(Decimal value) {
      System.Diagnostics.Debug.Assert(this.minimum <= this.maximum);
    ...
    public override bool KeyEntersEditMode(KeyEventArgs e) {
      ...
      if (!string.IsNullOrEmpty(negativeSignStr) && negativeSignStr.Length == 1) {
        ...
        negativeSignKey = (Keys)(TP.Base.Interop.Sendkeys.GetKeyForCharacter(negativeSignStr[0]));
      }
    ...
    protected override void Paint(Graphics graphics, Rectangle clipBounds, Rectangle cellBounds, int rowIndex, DataGridViewElementStates cellState,
      ...
      if (!cellEdited) {
        if (PartPainted(paintParts, DataGridViewPaintParts.ContentForeground)) {
          ...
          // original code does not work after closing the form with the dgv
          // exception when painting the first cell, so trap it and re-init the
          // disposed up/down.
    ...
    internal void SetDecimalPlaces(int rowIndex, int value) {
      System.Diagnostics.Debug.Assert(value >= 0 && value <= 99);
    ...
    internal void SetIncrement(int rowIndex, Decimal value) {
      System.Diagnostics.Debug.Assert(value >= (Decimal)0.0);
    ...
    internal void SetMaximum(int rowIndex, Decimal value) {
      ...
      System.Diagnostics.Debug.Assert(this.maximum == value);
      if (OwnsEditingNumericUpDown(rowIndex)) {
    ...
    internal void SetMinimum(int rowIndex, Decimal value) {
      ...
      System.Diagnostics.Debug.Assert(this.minimum == value);
      if (OwnsEditingNumericUpDown(rowIndex)) {
    ...
    public override string ToString() {
      return "DataGridViewNumericUpDownCell { ColumnIndex=" + ColumnIndex.ToString(System.Globalization.CultureInfo.CurrentCulture) + ", RowIndex=" + RowIndex.ToString(System.Globalization.CultureInfo.CurrentCulture) + " }";
    }
