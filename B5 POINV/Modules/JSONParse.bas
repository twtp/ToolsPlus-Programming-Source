...
'
Public Function Decode(ByRef str As String) As Object
   Dim index As Long
   index = 1
   psErrors = ""
   ...
   Select Case Mid(str, index, 1)
      Case "{"
         Set Decode = parseObject(str, index)
      Case "["
         Set Decode = parseArray(str, index)
      Case Else
         psErrors = "Invalid JSON"
   End Select
End Function

Public Function Encode(ByRef obj As Variant) As String
      ...
      Case vbObject
         ...
         If TypeName(obj) = "Dictionary" Then
            ...
            For i = 0 To obj.Count - 1
               ...
               Dim key
               key = keys(i)
               SB.Append """" & key & """:" & Encode(obj.Item(key))
            Next i
            SB.Append "}"
...
Private Function encodeUnicode(str) As String
...
Public Function StringToJSON(st As String) As String
   ...
   Dim sFlds As String
   Dim sRecs As StringBuilder
   Set sRecs = New StringBuilder
   Dim lRecCnt As Long
   Dim lFld As Long
   Dim fld As Variant
   Dim rows As Variant
...
Public Function toUnicode(str As String) As String
   ...
   Dim x As Long
   Dim uStr As StringBuilder
   Set uStr = New StringBuilder
